...
# ---------- Customer generator (Updated with Kenyan name generator) ----------
def generate_customer(customer_id: int) -> dict:
    ...
    address_line1 = f"{random.randint(1, 200)} {fake.street_name()}"
...
def main():
    ...
    try:
        ...
        print("SUCCESS: All synthetic tables created and populated.")
